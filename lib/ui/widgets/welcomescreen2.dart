                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            ...
                            style: secondaryListTitle.copyWith(color: bmsWhite),
                          ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              'Make GST invoices\nfrom the app!',
                              style:
                                  secondaryListTitle.copyWith(color: bmsWhite),
                            ),
                            SizedBox(height: 15.0),
                            Text(
                              'Select from parties & products from Tally to create new invoices from TallyAssist.',
                              style:
                                  secondaryListDisc.copyWith(color: bmsWhite),
                            ),
                          ],
                        ),
                      ),
...
//                   .textTheme
//                   .headline
//                   .copyWith(fontSize: 24.0, color: bmsWhite),
//                 ),
//                 SizedBox(height: 50),
//                 Text(
...
//                   .textTheme
//                   .headline
//                   .copyWith(fontSize: 20.0, color: bmsWhite),
//                 ),
//                 SizedBox(height: 30),
//                  RaisedButton(
//                    color: bmsWhite,
