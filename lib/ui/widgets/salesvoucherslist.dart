...
import 'package:bms/ui/widgets/salesvouchertile.dart';
...
class _SalesVoucherListState extends State<SalesVoucherList> {
  ...
  List<Voucher> salesVoucherDataforDisplay = <Voucher>[];
  ...
  void filterSearchResults(String query) {
    List<Voucher> dummySearchList = <Voucher>[];
    dummySearchList.addAll(salesVoucherData!);
    if (query.isNotEmpty) {
      List<Voucher> dummyListData = <Voucher>[];
