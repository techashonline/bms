...
import 'package:bms/ui/widgets/stockscreen/stocktile.dart';
...
class _StockItemListState extends State<StockItemList> {
  ...
  List<StockItem> stockItemDataforDisplay = <StockItem>[];
  ...
  void filterSearchResults(String query) {
    List<StockItem> dummySearchList = <StockItem>[];
    dummySearchList.addAll(stockItemData!);
    if (query.isNotEmpty) {
      List<StockItem> dummyListData = <StockItem>[];
