...
import 'package:bms/ui/widgets/partyscreen/ledgertile-new.dart';
...
class _LedgerItemListState extends State<LedgerItemList> {
  ...
  List<LedgerItem>? ledgerItemDataforDisplay = <LedgerItem>[];
  ...
  void filterSearchResults(String query) {
    List<LedgerItem> dummySearchList = <LedgerItem>[];
    dummySearchList.addAll(ledgerItemData!);
    if (query.isNotEmpty) {
      List<LedgerItem> dummyListData = <LedgerItem>[];
