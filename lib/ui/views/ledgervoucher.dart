...
class _VoucherListState extends State<VoucherList> {
  ...
  List<LedgerVoucherModel>? voucherDataforDisplay = <LedgerVoucherModel>[];
  ...
  void filterSearchResults(String query) {
    List<LedgerVoucherModel> dummySearchList = <LedgerVoucherModel>[];
    dummySearchList.addAll(voucherData!);
    if (query.isNotEmpty) {
      List<LedgerVoucherModel> dummyListData = <LedgerVoucherModel>[];
