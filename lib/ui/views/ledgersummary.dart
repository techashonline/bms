...
import 'package:bms/templates/ledgeraccount_pdf_template.dart';
    ...
    return WillPopScope(
        ...
        child: SingleChildScrollView(
          child: Column(children: <Widget>[
                  ...
                  Row(children: <Widget>[
                    Container(
                        ...
                        child: Text(
                          ...
                          maxLines: 2,
                          style: TextStyle(color: bmsPrimary),
                        ))
                  ]),
                  Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            ElevatedButton(
                              child: Row(
                                children: <Widget>[
                                  Text(
                                    'Send PDF',
                                    style: TextStyle(color: bmsMenuBg),
                                  ),
                                  // Icon(Icons.picture_as_pdf, color: bmsMenuBg),
                                ],
                              ),
                              onPressed: () => viewPdf(
            ...
            Container(height: 3.0, color: bmsPrimary),
            Padding(
