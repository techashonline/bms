...
import 'package:bms/core/services/ledgerparty.dart';
import 'package:bms/core/models/ledgerparty.dart';
import 'package:bms/core/services/string_format.dart';
import 'package:bms/ui/shared/positiveamount.dart';
import 'package:bms/ui/shared/debitcredit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Iterable<Voucher> voucherList =
        Provider.of<List<Voucher>>(context, listen: false)
            ...
            [];
    Voucher voucher = voucherList.elementAt(0) ?? [] as Voucher;
    ...
    Iterable<LedgerItem>? ledgerItem = Provider.of<List<LedgerItem>>(context)
        ...
        [];
    LedgerItem ledger = ledgerItem!.elementAt(0) ?? [] as LedgerItem;
              ...
              body: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(height: 3.0, color: bmsGray),
                    Padding(
                      padding: spacer.all.xxs,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    //   color: bmsGray
                    // ),
                    // Text('Total Invoice: ${voucher.amount}', style: Theme.of(context).textTheme.body2,)
                  ],
                ),
              ))),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return // PDF Sharing button
        ElevatedButton(
            ...
            child: Row(
              children: <Widget>[
                Text('Send PDF  ', style: TextStyle(color: bmsWhite)),
                Icon(Icons.picture_as_pdf, color: bmsWhite),
              ],
            ),
            onPressed: () async {
              // String logoPath;
              ...
              viewPdf(context, voucher, company, ledger, ""
                  // logoPath,
                  // inventoryEntries,
                  );
            });
