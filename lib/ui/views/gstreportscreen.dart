...
import 'package:bms/ui/widgets/gstcard.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          body: ListView(children: <Widget>[
            ...
            GSTCard('IGST', 'Input', 'Rs. 12,13,234', 'Output', 'Rs. 12,11,234',
                'Net Payable', 'Rs. 12,345'),
            GoToBar('Due IGST From/To', GstReportScreen()),
            GSTCard('CGST', 'Input', 'Rs. 12,13,234', 'Output', 'Rs. 12,11,234',
                'Net Payable', 'Rs. 12,345'),
            GoToBar('Due CGST From/To', GstReportScreen()),
            GSTCard('SGST', 'Input', 'Rs. 12,13,234', 'Output', 'Rs. 12,11,234',
                'Net Payable', 'Rs. 12,345'),
            GoToBar('Due SGST From/To', GstReportScreen()),
            GSTCard('Total GST', 'Input', 'Rs. 12,13,234', 'Output',
                'Rs. 12,11,234', 'Net Payable', 'Rs. 12,345'),
